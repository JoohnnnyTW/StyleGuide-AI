...
import { GeneratedImageHistoryEntry, Project } from '../../App'; // Adjust path as needed
            ...
            <div className="flex-shrink-0 p-2 sm:p-3 border-t border-gray-200 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-800/80">
                ...
                <div className="flex gap-1.5 sm:gap-2 justify-end">
                    <button
                        ...
                        className="px-2 py-1 text-[0.65rem] sm:px-3 sm:py-1.5 sm:text-xs bg-sky-500/90 text-white rounded-md hover:bg-sky-600 shadow-sm transition-colors disabled:opacity-50 disabled:cursor-wait"
                    ...
                    <button
                        ...
                        className="px-2 py-1 text-[0.65rem] sm:px-3 sm:py-1.5 sm:text-xs bg-green-500/90 text-white rounded-md hover:bg-green-600 shadow-sm transition-colors disabled:opacity-50 disabled:cursor-wait"
                    ...
                    {onGenerateReport && (
                        ...
                        >
                            {isGeneratingReport ? 
                                ...
                                : <FileTextIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                            }
                           {isGeneratingReport ? "報告生成中..." : "生成報告"}
                        </button>
                    )}
                </div>
            </div>
